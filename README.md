...
This project analyzes the performance of posts from an Instagram account using Python and Jupyter Notebook.
The objective is to understand the factors that influence reach, engagement, impressions, and follower growth, and to identify which types of content consistently perform well.
...
python final project instgram account analysis.ipynb
...
git clone https://github.com/amarosama10amar-ux/instagram-data-analysis.git
Open the notebook:
jupyter notebook "python final project instgram account analysis.ipynb"
Contact
